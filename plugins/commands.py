...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url=f"https://t.me/Kfhdhshh"),
            ],
            [
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**NEW USERS MUST JOIN THE CHANNEL BELOW TO GET YOUR MOVIE \n THEN COME BACK HERE AND TAP ON --TRY AGAIN-- U r movie will come **",
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/Kfhdhshh') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
