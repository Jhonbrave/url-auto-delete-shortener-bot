...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://youtu.be/HV_nUsb5-vY')
        ]
    )
...
async def advantage_spoll_choker(bot, query):
    ...
    if int(user) != 0 and query.from_user.id != int(user):
        return await query.answer("😁 𝗛𝗲𝘆 𝗙𝗿𝗶𝗲𝗻𝗱\nPleace Type the Movie Name 𝗬𝗼𝘂𝗿𝘀𝗲𝗹𝗳☺️.", show_alert=True)
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('𝚃𝙷𝙸𝚂 𝙼𝙾𝚅𝙸𝙴 I𝚂 𝙽𝙾𝚃 𝚈𝙴𝚃 𝚁𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝙾𝚁 𝙰𝙳𝙳𝙴𝙳 𝚃𝙾 𝙳𝙰𝚃𝚂𝙱𝙰𝚂𝙴/n IF YOU WANT IT JUST TYPE👇👇\n #REQUEST,MOVIE NAME,LANGUAGE\n we will upload for you soon🥰💌')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://t.me/Kfhdhshh'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/Kfhdhshh')
        ], [
